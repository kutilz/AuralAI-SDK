## 1\. Object Detection Concept[#](https://wiki.sipeed.com/maixpy/doc/en/vision/yolov5.html#Object-Detection-Concept)
...
For more API usage, refer to the documentation for the [maix.nn](https://wiki.sipeed.com/maixpy/api/maix/nn.html) module.

## 3\. dual\_buff for Double Buffering Acceleration[#](https://wiki.sipeed.com/maixpy/doc/en/vision/yolov5.html#dual_buff-for-Double-Buffering-Acceleration)

You may notice that the model initialization uses `dual_buff` (default value is `True`). Enabling the `dual_buff` parameter can improve efficiency and increase the frame rate. For more details and usage considerations, see the [dual\_buff Introduction](https://wiki.sipeed.com/maixpy/doc/en/vision/dual_buff.html).

## 4\. More Input Resolutions[#](https://wiki.sipeed.com/maixpy/doc/en/vision/yolov5.html#More-Input-Resolutions)
...
## 5\. Which Model to Use: YOLOv5, YOLOv8, or YOLO11?[#](https://wiki.sipeed.com/maixpy/doc/en/vision/yolov5.html#Which-Model-to-Use%3A-YOLOv5%2C-YOLOv8%2C-or-YOLO11%3F)
...
## 6\. Different Resolutions for Camera and Model[#](https://wiki.sipeed.com/maixpy/doc/en/vision/yolov5.html#Different-Resolutions-for-Camera-and-Model)
...
## 7\. Training Your Own Object Detection Model on MaixHub[#](https://wiki.sipeed.com/maixpy/doc/en/vision/yolov5.html#Training-Your-Own-Object-Detection-Model-on-MaixHub)

If you need to detect specific objects beyond the 80 categories provided, visit [MaixHub](https://maixhub.com/) to learn and train an object detection model. Select "Object Detection Model" when creating a project. Refer to the [MaixHub Online Training Documentation](https://wiki.sipeed.com/maixpy/doc/en/vision/maixhub_train.html).
...
## 8\. Training Your Own Object Detection Model Offline[#](https://wiki.sipeed.com/maixpy/doc/en/vision/yolov5.html#Training-Your-Own-Object-Detection-Model-Offline)
...
Refer to [Training a Custom YOLOv5 Model](https://wiki.sipeed.com/maixpy/doc/en/vision/customize_model_yolov5.html) or [Training a Custom YOLOv8/YOLO11 Model Offline](https://wiki.sipeed.com/maixpy/doc/en/vision/customize_model_yolov8.html).

## 9\. Appendix: 80 Classes[#](https://wiki.sipeed.com/maixpy/doc/en/vision/yolov5.html#Appendix%3A-80-Classes)
