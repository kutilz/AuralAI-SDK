## 1\. Introduction[#](https://wiki.sipeed.com/maixpy/doc/en/vision/display.html#Introduction)
...
## 2\. API Documentation[#](https://wiki.sipeed.com/maixpy/doc/en/vision/display.html#API-Documentation)

This document introduces commonly used methods. For more APIs, please refer to the [display](https://wiki.sipeed.com/maixpy/api/maix/display.html) section of the API documentation.

## 3\. Using the Screen[#](https://wiki.sipeed.com/maixpy/doc/en/vision/display.html#Using-the-Screen)
...
## 4\. Adjusting Backlight Brightness[#](https://wiki.sipeed.com/maixpy/doc/en/vision/display.html#Adjusting-Backlight-Brightness)
...
## 5\. Displaying on MaixVision[#](https://wiki.sipeed.com/maixpy/doc/en/vision/display.html#Displaying-on-MaixVision)
...
## 6\. Replacing with Other Screen Models[#](https://wiki.sipeed.com/maixpy/doc/en/vision/display.html#Replacing-with-Other-Screen-Models)
