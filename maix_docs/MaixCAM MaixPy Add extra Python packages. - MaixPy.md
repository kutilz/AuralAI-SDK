## 1\. Introduction[#](https://wiki.sipeed.com/maixpy/doc/en/basic/python_pkgs.html#Introduction)
...
## 2\. Installing Additional Python Packages[#](https://wiki.sipeed.com/maixpy/doc/en/basic/python_pkgs.html#Installing-Additional-Python-Packages)
...
### 2.1. Method 1: Installing Using Python Code[#](https://wiki.sipeed.com/maixpy/doc/en/basic/python_pkgs.html#Method-1%3A-Installing-Using-Python-Code)
...
### 2.2. Method 2: Installing Using the Terminal and pip Command[#](https://wiki.sipeed.com/maixpy/doc/en/basic/python_pkgs.html#Method-2%3A-Installing-Using-the-Terminal-and-pip-Command)

Follow the terminal usage method introduced in [Linux Basics](https://wiki.sipeed.com/maixpy/doc/en/basic/linux_basic.html) and use `pip install package_name` to install the package you need.

## 3\. Packages That Cannot Be Installed Directly with pip[#](https://wiki.sipeed.com/maixpy/doc/en/basic/python_pkgs.html#Packages-That-Cannot-Be-Installed-Directly-with-pip)
