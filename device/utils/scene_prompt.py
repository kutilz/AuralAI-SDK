...
_LEVEL_ORANG = (
    "ORANG: berapa orang, di arah mana, dan apa yang sedang mereka lakukan "
    "kalau jelas terlihat. Jangan menebak nama, usia, atau suku."
)
...
_ATURAN = (
    ...
    "- Sebut paling banyak dua benda. Kalau beberapa benda berada di tingkat "
    ...
    "ke kiri lebih dulu. Aturan ini yang membuat jawaban untuk pemandangan "
    ...
    "- Sebut HANYA yang benar-benar kamu lihat dengan jelas. Kalau sebuah "
    ...
    "hewan, orang, wajah, atau merek dari bentuk yang tidak jelas. Lebih baik "
    "menyebut sedikit tapi benar daripada banyak tapi salah.\n"
...
SCENE_PROMPT_SEDANG = _compose(
    ...
    "tempat.",
    "ATURAN JAWABAN: satu kalimat Bahasa Indonesia, maksimal 14 kata. Sebut "
    "paling banyak dua benda, yang paling dekat lebih dulu, lalu yang lebih ke "
    "kiri. Arah "
    "hanya: kiri, depan, kanan. Jarak hanya: di tangan, dekat, jauh. Pakai "
    "kata benda yang sama setiap kali untuk benda yang sama. Untuk gambar yang "
    "sama, jawab persis sama. Sebut hanya yang benar-benar terlihat jelas; "
    "kalau bentuknya tidak jelas, sebut bentuk kasarnya saja dan dilarang "
    "menebak hewan, orang, atau merek. Dilarang memakai kata gambar, foto, "
